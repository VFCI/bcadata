...
Finally, the package includes the original dataset from the [author's replication files](https://www.openicpsr.org/openicpsr/project/118082/version/V1/view).
``` r 
original_bcadata
```
